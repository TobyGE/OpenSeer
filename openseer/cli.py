...
# `site` is intentionally kept here even though the per-site CLI was
# removed (commit 6f… revert of 38e0df8 / 5ea0ae2 / 1cf76bc). Without
# it, `openseer site reddit hot ...` would be silently rewritten as
# `openseer task site reddit hot ...` by main() below and kick off
